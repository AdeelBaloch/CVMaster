...
class MSWordController extends Controller
{
        ...
        public function GanerateWord($InfoId)
        {
            $FileName = $this->ObjCV->GetBasicInfo($InfoId)->FirstName." ".$this->ObjCV->GetBasicInfo($InfoId)->LastName.".docx";

            $this->createDoc($this->ObjCV->ViewCV($InfoId), $FileName, true);
            // $pdf =  PDF::loadHTML($this->ObjCV->ViewCV($InfoId))->setPaper('A4', 'legal')->setWarnings(false)->save($FileName);
            // PDF::setOptions(['dpi' => 150, 'defaultFont' => 'sans-serif']);
            // return $pdf->download($FileName);
    
            $this->ObjLog->AddLog("Ganerated a New CV In Word File");
